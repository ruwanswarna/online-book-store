<?php
   ...
   include("header.php");
    ...
    if(isset($_POST['checkout'])){
			...
			$sql = "INSERT INTO orders(id,name,phone,address,district,postcode,email,checkout_id) VALUES(?,?,?,?,?,?,?,?)";
           
			
			if($stmt = mysqli_prepare($con,$sql)){
				mysqli_stmt_bind_param($stmt,'isssssss',$param_id,$param_name,$param_phone,$param_address,$param_district,$param_postcode,$param_email,$param_checkout_id);
				$param_id = '';
                $param_name = $name;
